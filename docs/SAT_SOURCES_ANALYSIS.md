...
- **ВАК/РИНЦ:** 0 → нужно ≥30% от финального списка (т.е. ≥12–15 при 40–50 источниках)
- **Scopus/WoS:** ~12–14 → нужно ≥20%
- **Фундаментальные (до 2020):** допустимы как основы области

> **⚠️ КРИТИЧЕСКИЙ ДЕФИЦИТ:** русскоязычные ВАК-источники отсутствуют. Задача для фазы 4: целевой поиск в eLibrary.ru по направлениям L1–L8.
...
2. **Добить ВАК/РИНЦ:** русскоязычные источники по eLibrary.ru. Направления: «управление доступом СДО», «онтологии образование», «семантические технологии обучение», «верификация правил доступа»
